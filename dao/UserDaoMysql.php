...
class UserDaoMysql implements UserDAO{
    ...
    public function generateUser($array, $full = false){
        $u = new User();
        $u->id = $array['id'] ? $array['id'] : '0';
        $u->email = $array['email'] ? $array['email'] : '';
        $u->password = $array['password'] ? $array['password'] : '';
        $u->name = $array['name'] ? $array['name'] : '';
        $u->birthdate = $array['birthdate'] ? $array['birthdate'] : '';
        $u->city = $array['city'] ? $array['city'] : '';
        $u->work = $array['work'] ? $array['work'] : '';
        $u->avatar = $array['avatar'] ? $array['avatar'] : '';
        $u->cover = $array['cover'] ? $array['cover'] : '';
        $u->token =$array['token'] ? $array['token'] :'';
